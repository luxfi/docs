...
](https://github.com/luxdefi/cli), pero por ahora debemos hacerlo manualmente.

Ve a la [página de versiones](https://github.com/luxdefi/subnet-evm/releases) del repositorio de Subnet-EVM.
