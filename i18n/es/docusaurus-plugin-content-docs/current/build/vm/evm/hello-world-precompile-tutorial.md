...
A [precompile](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/core/vm/contracts.go#L54-L57)
...
[sha256 precompile](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/core/vm/contracts.go#L237-L250)
function.
...
[Coreth](https://github.com/luxdefi/coreth) and [Subnet-EVM](https://github.com/luxdefi/subnet-evm).

A stateful precompile follows this [interface](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contract/interfaces.go#L17-L20):
...
`IAllowList` is defined in Subnet-EVM under [`./contracts/contracts/interfaces/IAllowList.sol`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/contracts/contracts/interfaces/IAllowList.sol).
...
[here](https://github.com/luxdefi/subnet-evm/tree/helloworld-official-tutorial-v2). The code in this
...
[Precompile-EVM](https://github.com/luxdefi/precompile-evm). Both Subnet-EVM and Precompile-EVM share
similar directory structures and common codes.
You can reference the Precompile-EVM PR that adds Hello World precompile [here](https://github.com/luxdefi/precompile-evm/pull/12)
...
Alternatively you can use it as a template repo from [github](https://github.com/luxdefi/precompile-evm/generate).
...
[Subnet-EVM Hello World Pull Request](https://github.com/luxdefi/subnet-evm/pull/565/)

</TabItem>
<TabItem value="precompile-evm-tab" label="Precompile-EVM"  >

[Precompile-EVM Hello World Pull Request](https://github.com/luxdefi/precompile-evm/pull/12/)
...
For a full-fledged example, you can also check out the [Reward Manager Precompile](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contracts/rewardmanager/)
...
can be accessible through `@luxdefi/subnet-evm-contracts` package.
...
In Precompile-EVM we import contracts from `@luxdefi/subnet-evm-contracts` package.
...
In Subnet-EVM precompile implementations reside under the [`./precompile/contracts`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contracts) directory. Let's generate our precompile
...
under [`precompile/registry/registry.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/registry/registry.go).
...
[`CALL`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/core/vm/evm.go#L284),
[`CALLCODE`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/core/vm/evm.go#L355),
[`DELEGATECALL`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/core/vm/evm.go#L396),
[`STATICCALL`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/core/vm/evm.go#L445),
...
[`./precompile/helloworld/module.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contracts/helloworld/module.go)
for Subnet-EVM and
[./helloworld/module.go](https://github.com/luxdefi/precompile-evm/blob/hello-world-example/helloworld/module.go)
for Precompile-EVM.
...
file is located at [`./precompile/helloworld/contract.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contracts/helloworld/contract.go)
for Subnet-EVM and
...
in [`precompile/contract/utils.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contract/utils.go#L19-L20).
...
under Subnet-EVM's [`precompile/allowlist/allowlist.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/allowlist/allowlist.go#L28-L29).
...
For Subnet-EVM we have a precompile registry under [`/precompile/registry/registry.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/registry/registry.go).
...
The registry itself also force-imported by the [`/plugin/evm/vm.go](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/plugin/evm/vm.go#L50).
...
For Precompile-EVM there is a [`plugin/main.go`](https://github.com/luxdefi/precompile-evm/blob/hello-world-example/plugin/main.go)
...
be under [`./precompile/contracts/helloworld/config_test.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contracts/helloworld/config_test.go)
for Subnet-EVM and [`./helloworld/config_test.go`](https://github.com/luxdefi/precompile-evm/blob/hello-world-example/helloworld/config_test.go)
for Precompile-EVM.
...
under the Subnet-EVM's [`./precompile/contracts`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contracts/)
...
tests will be under [`./precompile/contracts/helloworld/contract_test.go`](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/precompile/contracts/helloworld/contract_test.go)
for Subnet-EVM and
[`./helloworld/contract_test.go`](https://github.com/luxdefi/precompile-evm/blob/hello-world-example/helloworld/contract_test.go)
for Precompile-EVM.
...
TestRewardManagerPrecompileSetRewardAddress function in [here](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/plugin/evm/vm_test.go#L2675).
...
For Precompile-EVM, you should import `AllowListTest` with `@luxdefi/subnet-evm-contracts` NPM package:
...
import "../ExampleHelloWorld.sol";
import "../interfaces/IHelloWorld.sol";
import "@luxdefi/subnet-evm-contracts/contracts/test/AllowListTest.sol";
...
You can find more information about the test framework [here](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/contracts/test/utils.ts).
...
import { ethers } from "hardhat";
import { test } from "@luxdefi/subnet-evm-contracts";
...
See how they were used with default params [here](https://github.com/luxdefi/subnet-evm/blob/helloworld-official-tutorial-v2/tests/utils/subnet.go#L113)
...
#### Building LuxGo and Subnet-EVM/Precompile-EVM
...
the [Prerequisites](#prerequisites) section, so you can build LuxGo with the following command:
...
```bash
Running Suite: subnet-evm small load simulator test suite - /Users/avalabs/go/src/github.com/luxdefi/subnet-evm
======================================================================================================================
...
[official tutorial implementation](https://github.com/luxdefi/subnet-evm/tree/helloworld-official-tutorial-v2)
...
If you used Precompile-EVM, you can update your repo by bumping Subnet-EVM versions in [`go.mod`](https://github.com/luxdefi/precompile-evm/blob/hello-world-example/go.mod#L7)
and [`version.sh`](https://github.com/luxdefi/precompile-evm/blob/hello-world-example/scripts/versions.sh#L4)
