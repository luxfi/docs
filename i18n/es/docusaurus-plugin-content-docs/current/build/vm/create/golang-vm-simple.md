...
[TimestampVM](https://github.com/luxdefi/timestampvm/tree/v1.2.1). Each block in the TimestampVM's
...
repository](https://github.com/luxdefi/timestampvm/tree/main).
...
This VM has a [build script](https://github.com/luxdefi/timestampvm/blob/v1.2.1/scripts/build.sh)
...
`$GOPATH/src/github.com/luxdefi/luxd/build/plugins/tGas3T58KzdjLHhBDMnH2TvrddhqTji5iZAMZ3RXs2NLpSnhH`
