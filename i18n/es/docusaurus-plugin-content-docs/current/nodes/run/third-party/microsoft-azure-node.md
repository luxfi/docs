...
Primero, ingresa un nombre para la máquina virtual, puede ser cualquier cosa, pero en mi ejemplo, lo he llamado Lux (esto también cambiará automáticamente el nombre del grupo de recursos para que coincida).
