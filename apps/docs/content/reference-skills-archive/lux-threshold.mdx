...
| **Corona** | Lattice | Variable | - | Post-quantum (128/192/256-bit) |
...
```go
pqAdapter := adapters.NewCoronaAdapter(256, numParties) // 256-bit PQ security
...
github.com/luxfi/lattice/v7@v7.0.0     -- Lattice ops for Corona (PQ)
github.com/luxfi/corona@v0.2.0       -- Post-quantum threshold signatures
...
- `lux/lux-lattice.md` -- Lattice crypto used by Corona protocol
