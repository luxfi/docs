...
|---------|------|----------|-----|-------------|
| `0x0600` | ML_DSA | FIPS 204 | 50,000 | ML-DSA signature verification (ML-DSA) |
| `0x0601` | ML_KEM | FIPS 203 | 25,000 | ML-KEM key encapsulation (ML-KEM) |
| `0x0602` | SLH_DSA | FIPS 205 | 75,000 | SLH-DSA hash-based signatures (SLH-DSA (FIPS 205, formerly SPHINCS+)) |
...
|---------|--------|-----------|-------------|
| `0x0610` | Hybrid BLS+Pulsar | BLS12-381 | Pulsar lattice |
| `0x0611` | Hybrid ECDSA+ML-DSA | secp256k1 | ML-DSA-65 |
| `0x0612` | Hybrid Schnorr+Pulsar | Ed25519 | Pulsar lattice |
