...
```
http://localhost:9650/v1/metrics
```
...
- [Validator Guide](/nodes/validator) - Upgrade your full node to a validator
- [Archive Node](/nodes/archive) - Run a node with full historical state
- [Health API](/api-reference/health) - Monitor node health programmatically
- [Info API](/api-reference/info) - Query node information
