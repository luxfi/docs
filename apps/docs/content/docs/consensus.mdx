...
The Lux protocol extends Snowball to operate over a directed acyclic graph (DAG) of transactions. This is used on the X-Chain for high-throughput asset transfers.
...
|-------|----------|--------|
| **X-Chain** | Lux (DAG) | High-throughput parallel asset transfers |
...
- [Architecture](/learn/architecture) - How consensus integrates with the multi-chain design
- [Tokenomics](/learn/tokenomics) - Staking requirements for validators participating in consensus
- [Run a Validator](/nodes/validator) - Participate in consensus by running a validator node
