...
- [Architecture](/architecture) - How consensus integrates with the multi-chain design
- [Tokenomics](/tokenomics) - Staking requirements for validators participating in consensus
