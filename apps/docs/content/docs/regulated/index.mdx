...
5. Optionally delegate real-time scored monitoring to the [Lux AML engine](/compliance/aml) (`luxfi/aml`)
...
- At least one provider API key (see [Provider Integration](/regulated/providers))
...
- [Alternative Trading System (ATS)](/regulated/ats) -- Build an SEC-registered ATS with internal matching
- [Broker-Dealer (BD)](/regulated/bd) -- Build a FINRA-registered BD with multi-venue routing
- [Transfer Agent (TA)](/regulated/ta) -- Build an SEC-registered TA for securities records
- [Provider Integration](/regulated/providers) -- Connect to 16+ trading venues
- [Compliance Integration](/regulated/compliance-integration) -- KYC, AML, and regulatory frameworks
