...
|---------|------------|-----------|-----|
| Mainnet | 1 | 96369 | `https://api.lux.network/v1/bc/C/rpc` |
| Testnet | 2 | 96368 | `https://api.lux-test.network/v1/bc/C/rpc` |
| Devnet | 3 | 96370 | `https://api.lux-dev.network/v1/bc/C/rpc` |
