...
<Cards>
  <Card title="Try the App" href="/dao/learn-more/app" icon="external-link">
    Launch the governance application and start participating
  </Card>
  <Card title="Contract Audit" href="/dao/learn-more/audit" icon="shield-check">
    Review security audits and smart contract verification
  </Card>
  <Card title="FAQ" href="/dao/learn-more/faq" icon="help-circle">
...
|----------|-------------|
| [User Guide](/dao/guide) | Complete guide to using the platform |
| [Governance](/dao) | Technical governance documentation |
| [Proposals](/dao/guide/resolutions) | How to create and manage proposals |
...
<Callout type="info">
For detailed security information, see the [Contract Audit](/dao/learn-more/audit) page.
</Callout>
