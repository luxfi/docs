...
<Cards>
  <Card title="Try the App" href="/learn-more/app" icon="external-link">
    Launch the governance application and start participating
  </Card>
  <Card title="Contract Audit" href="/learn-more/audit" icon="shield-check">
    Review security audits and smart contract verification
  </Card>
  <Card title="FAQ" href="/learn-more/faq" icon="help-circle">
...
| [Governance](/governance) | Technical governance documentation |
| [Proposals](/guide/resolutions) | How to create and manage proposals |
...
<Callout type="info">
For detailed security information, see the [Contract Audit](/learn-more/audit) page.
</Callout>
