...
<Cards>
  <Card title="Core Audit Report" href="https://github.com/luxfi" icon="file-text">
    Full audit report (PDF)
  </Card>
  <Card title="Governance Audit" href="https://github.com/luxfi" icon="file-text">
...
<Cards>
  ...
  <Card title="User Guide" href="/dao/guide" icon="book">
