...
The protocol is deployed on [Network]. See the [Contract Audit](/dao/learn-more/audit) page for deployed contract addresses.
...
See the [Voting Guide](/dao/guide/voting) for detailed instructions.
...
Yes. All core contracts have been audited by independent security firms. See [Contract Audit](/dao/learn-more/audit) for details.
...
Yes, gasless voting is supported through meta-transactions. See [Gasless Voting](/dao/guide/gasless) for setup instructions.
...
<Cards>
  <Card title="Discord" href="https://discord.gg/lux" icon="message-circle">
    Ask the community
  </Card>
  <Card title="Forum" href="https://discord.gg/lux" icon="messages">
    Detailed discussions
  </Card>
  <Card title="Support" href="https://discord.gg/lux" icon="mail">
    Contact the team
  </Card>
</Cards>
