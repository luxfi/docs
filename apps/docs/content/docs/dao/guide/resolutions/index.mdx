...
<Cards>
  <Card title="Action-Based" href="/dao/guide/resolutions/action-based" icon="zap">
...
<Cards>
  <Card title="From Scratch" href="/dao/guide/resolutions/from-scratch" icon="edit">
...
<Cards>
  <Card title="dApp Explorer" href="/dao/guide/resolutions/dapp-explorer" icon="globe">
...
- See [Executing a Proposal](/dao/guide/voting/execution)
