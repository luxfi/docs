...
<Cards>
  <Card title="Action-Based" href="/guide/resolutions/action-based" icon="zap">
...
<Cards>
  <Card title="From Scratch" href="/guide/resolutions/from-scratch" icon="edit">
...
<Cards>
  <Card title="Templates" href="/guide/resolutions/templates" icon="copy">
...
<Cards>
  <Card title="dApp Explorer" href="/guide/resolutions/dapp-explorer" icon="globe">
...
- See [Executing a Proposal](/guide/voting/execution)
