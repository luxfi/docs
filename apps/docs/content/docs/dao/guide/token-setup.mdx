...
<Cards>
  <Card title="Multisig Operations" href="/dao/guide/multisig" icon="key">
    Learn to sign multisig proposals
  </Card>
  <Card title="Treasury Management" href="/dao/guide/treasury" icon="vault">
    Manage treasury funds
  </Card>
  <Card title="Staking Setup" href="/dao/guide/staking/setup" icon="lock">
