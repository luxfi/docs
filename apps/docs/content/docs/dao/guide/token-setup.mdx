...
<Cards>
  <Card title="Multisig Operations" href="/guide/multisig" icon="key">
    Learn to sign multisig proposals
  </Card>
  <Card title="Treasury Management" href="/guide/treasury" icon="vault">
    Manage treasury funds
  </Card>
  <Card title="Staking Setup" href="/guide/staking/setup" icon="lock">
