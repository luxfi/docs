...
|--------------|----------|--------|
| [Transfer](/dao/guide/payments/transfer) | One-time payments | Immediate |
| [Airdrop](/dao/guide/payments/airdrop) | Multi-recipient distribution | Batch |
| [Stream](/dao/guide/payments/stream) | Continuous payments | Over time |
| [Stream to Role](/dao/guide/payments/stream-to-role) | Role-based streams | Automatic |
...
<Cards>
  <Card title="Transfer" href="/dao/guide/payments/transfer" icon="send">
    One-time payments to single recipient
  </Card>
  <Card title="Airdrop" href="/dao/guide/payments/airdrop" icon="users">
    Distribute to multiple addresses at once
  </Card>
  <Card title="Stream" href="/dao/guide/payments/stream" icon="clock">
    Continuous payments over time (Sablier-style)
  </Card>
  <Card title="Stream to Role" href="/dao/guide/payments/stream-to-role" icon="shield">
