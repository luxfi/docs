...
|--------------|----------|--------|
| [Transfer](/guide/payments/transfer) | One-time payments | Immediate |
| [Airdrop](/guide/payments/airdrop) | Multi-recipient distribution | Batch |
| [Stream](/guide/payments/stream) | Continuous payments | Over time |
| [Stream to Role](/guide/payments/stream-to-role) | Role-based streams | Automatic |
...
<Cards>
  <Card title="Transfer" href="/guide/payments/transfer" icon="send">
    One-time payments to single recipient
  </Card>
  <Card title="Airdrop" href="/guide/payments/airdrop" icon="users">
    Distribute to multiple addresses at once
  </Card>
  <Card title="Stream" href="/guide/payments/stream" icon="clock">
    Continuous payments over time (Sablier-style)
  </Card>
  <Card title="Stream to Role" href="/guide/payments/stream-to-role" icon="shield">
