...
<Callout type="info">
On-chain votes require gas. For gasless voting options, see [Gasless Voting](/dao/guide/gasless).
</Callout>
...
- [Delegate to trusted representatives](/dao/guide/voting/delegation)
