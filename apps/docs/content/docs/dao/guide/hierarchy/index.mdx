...
<Cards>
  <Card title="Create Sub-DAO" href="/guide/hierarchy/node-creation" icon="plus-circle">
    Spawn child nodes for delegation
  </Card>
  <Card title="Freeze Node" href="/guide/hierarchy/freezing" icon="pause-circle">
    Temporarily halt child operations
  </Card>
  <Card title="Clawback Funds" href="/guide/hierarchy/clawback" icon="rotate-ccw">
