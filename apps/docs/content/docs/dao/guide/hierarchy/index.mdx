...
<Cards>
  <Card title="Create Sub-DAO" href="/dao/guide/hierarchy/node-creation" icon="plus-circle">
    Spawn child nodes for delegation
  </Card>
  <Card title="Freeze Node" href="/dao/guide/hierarchy/freezing" icon="pause-circle">
    Temporarily halt child operations
  </Card>
  <Card title="Clawback Funds" href="/dao/guide/hierarchy/clawback" icon="rotate-ccw">
