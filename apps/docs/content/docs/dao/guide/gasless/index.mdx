...
<Cards>
  <Card title="Setup Gasless" href="/dao/guide/gasless/setup" icon="settings">
    Configure gasless voting for your DAO
  </Card>
  <Card title="Paymaster" href="/dao/guide/gasless/paymaster" icon="credit-card">
    Manage paymaster funding
  </Card>
  <Card title="Disabling" href="/dao/guide/gasless/disabling" icon="x-circle">
    Turn off gasless voting
  </Card>
  <Card title="Using Gasless" href="/dao/guide/gasless/using" icon="zap">
...
1. [Set up gasless voting](/dao/guide/gasless/setup)
2. [Fund the paymaster](/dao/guide/gasless/paymaster)
3. Configure eligibility policies
4. Test with a sample proposal

### For Voters

1. [Learn how to vote gasless](/dao/guide/gasless/using)
