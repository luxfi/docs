...
<Cards>
  <Card title="Setup Gasless" href="/guide/gasless/setup" icon="settings">
    Configure gasless voting for your DAO
  </Card>
  <Card title="Paymaster" href="/guide/gasless/paymaster" icon="credit-card">
    Manage paymaster funding
  </Card>
  <Card title="Disabling" href="/guide/gasless/disabling" icon="x-circle">
    Turn off gasless voting
  </Card>
  <Card title="Using Gasless" href="/guide/gasless/using" icon="zap">
...
1. [Set up gasless voting](/guide/gasless/setup)
2. [Fund the paymaster](/guide/gasless/paymaster)
3. Configure eligibility policies
4. Test with a sample proposal

### For Voters

1. [Learn how to vote gasless](/guide/gasless/using)
