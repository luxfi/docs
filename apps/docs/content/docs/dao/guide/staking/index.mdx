...
<Cards>
  <Card title="Setup Staking" href="/guide/staking/setup" icon="settings">
    Configure staking for your DAO
  </Card>
  <Card title="Distributions" href="/guide/staking/distributions" icon="pie-chart">
    Manage reward distributions
  </Card>
  <Card title="Using Staking" href="/guide/staking/using-staking" icon="lock">
...
See [Using Staking](/guide/staking/using-staking) for detailed instructions.
