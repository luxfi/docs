...
<Cards>
  <Card title="Setup Staking" href="/dao/guide/staking/setup" icon="settings">
    Configure staking for your DAO
  </Card>
  <Card title="Distributions" href="/dao/guide/staking/distributions" icon="pie-chart">
    Manage reward distributions
  </Card>
  <Card title="Using Staking" href="/dao/guide/staking/using-staking" icon="lock">
...
See [Using Staking](/dao/guide/staking/using-staking) for detailed instructions.
