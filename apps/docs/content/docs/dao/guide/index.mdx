...
<Cards>
  <Card title="Getting Started" href="/guide/getting-started" icon="play">
    Learn the basics and set up your account
  </Card>
  <Card title="Governance Types" href="/guide/getting-started/governance-types" icon="git-branch">
    Understand different governance models
  </Card>
  <Card title="Creating a Project" href="/guide/getting-started/creating-committee" icon="plus-circle">
...
<Cards>
  <Card title="Creating Proposals" href="/guide/resolutions" icon="file-plus">
    Submit governance proposals
  </Card>
  <Card title="Voting" href="/guide/voting" icon="check-square">
    Cast votes and participate in decisions
  </Card>
  <Card title="Delegation" href="/guide/voting/delegation" icon="users">
    Delegate your voting power
  </Card>
  <Card title="Execution" href="/guide/voting/execution" icon="play-circle">
...
<Cards>
  <Card title="Roles" href="/guide/roles" icon="shield">
    Create and manage roles
  </Card>
  <Card title="Treasury" href="/guide/treasury" icon="vault">
    Manage community funds
  </Card>
  <Card title="Hierarchy" href="/guide/hierarchy" icon="git-merge">
...
<Cards>
  <Card title="Payments" href="/guide/payments" icon="send">
    Airdrops, streams, and transfers
  </Card>
  <Card title="Staking" href="/guide/staking" icon="lock">
    Stake tokens for rewards
  </Card>
  <Card title="Distributions" href="/guide/distributions" icon="pie-chart">
    Asset distribution splits
  </Card>
  <Card title="Token Sales" href="/guide/token-sales" icon="trending-up">
    Conduct token sales
  </Card>
</Cards>
...
<Cards>
  <Card title="Gasless Voting" href="/guide/gasless" icon="zap">
    Vote without gas fees
  </Card>
  <Card title="Multisig" href="/guide/multisig" icon="key">
