...
<Cards>
  <Card title="Getting Started" href="/dao/guide/getting-started" icon="play">
    Learn the basics and set up your account
  </Card>
  <Card title="Governance Types" href="/dao/guide/getting-started/governance-types" icon="git-branch">
    Understand different governance models
  </Card>
  <Card title="Creating a Project" href="/dao/guide/getting-started/creating-committee" icon="plus-circle">
