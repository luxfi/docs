...
|---------|------|-----------|
| Mainnet | `https://api.lux.network/v1/chain/c` | `wss://api.lux.network/v1/chain/c/ws` |
| Testnet | `https://api.lux-test.network/v1/chain/c` | `wss://api.lux-test.network/v1/chain/c/ws` |
| Local | `http://localhost:9650/v1/chain/c` | `ws://localhost:9650/v1/chain/c/ws` |
...
curl -s -X POST --data '{
  ...
  "params": []
}' -H 'content-type:application/json' https://api.lux.network/v1/chain/c
```
...
```javascript
const ws = new WebSocket("wss://api.lux.network/v1/chain/c/ws");
...
<Callout>
  For production applications requiring higher throughput, run your own [full node](/nodes/full-node) or use a dedicated RPC provider.
</Callout>
...
- [Platform API](/api-reference/platform) - P-Chain staking and chain APIs
- [Info API](/api-reference/info) - Node information endpoints
- [JavaScript SDK](/api-reference/sdk-js) - Interact with JSON-RPC from JavaScript
