...
|---------|------|-----------|
| Mainnet | `https://api.lux.network/v1/bc/C/rpc` | `wss://api.lux.network/v1/bc/C/ws` |
| Testnet | `https://api.lux-test.network/v1/bc/C/rpc` | `wss://api.lux-test.network/v1/bc/C/ws` |
| Local | `http://localhost:9650/v1/bc/C/rpc` | `ws://localhost:9650/v1/bc/C/ws` |
...
curl -s -X POST --data '{
  ...
  "params": []
}' -H 'content-type:application/json' https://api.lux.network/v1/bc/C/rpc
```
...
```javascript
const ws = new WebSocket("wss://api.lux.network/v1/bc/C/ws");
