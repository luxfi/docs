...
<Cards>
  <Card title="JSON-RPC API" href="/reference/json-rpc">
    Ethereum-compatible JSON-RPC endpoints
  </Card>
  <Card title="Platform API" href="/reference/platform">
    P-Chain platform API reference
  </Card>
  <Card title="Info API" href="/reference/info">
    Node information and status
  </Card>
  <Card title="Health API" href="/reference/health">
