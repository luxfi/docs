...
// Testnet
const luxTestnet = new Lux("api.lux-test.network", 443, "https");
...
```typescript
const keychain = xchain.keyChain();
// Use a key derived from LUX_MNEMONIC -- never use well-known test keys
keychain.importKey(myPrivateKey);
...
const wsProvider = new ethers.WebSocketProvider(
  "wss://api.lux.network/v1/chain/c/ws"
);
...
- [Go SDK Reference](/api-reference/sdk-go) - Go SDK for backend services
- [JSON-RPC API](/api-reference/json-rpc) - Raw JSON-RPC methods
- [Smart Contracts](/cloud/contracts) - Deploy contracts to C-Chain
- [Tutorials](/cloud/tutorials) - End-to-end examples
