...
The Platform API provides access to the P-Chain, which manages validators, staking, and chains. All Platform API methods are accessed at the `/v1/P` endpoint (or equivalently `/v1/chain/p`).
