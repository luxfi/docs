...
| Zoo | L2 EVM | Hex (`0x...`) | EVM | 18 |
| Hanzo | L2 EVM | Hex (`0x...`) | EVM | 18 |
| SPC | L2 EVM | Hex (`0x...`) | EVM | 18 |
| Pars | L2 EVM | Hex (`0x...`) | EVM | 18 |
...
All L2 EVM chains (Zoo, Hanzo, SPC, Pars) use the same EVM interface as the C-Chain. The only difference is the RPC endpoint URL and chain ID.
