---
title: EVM Chains
description: Full-featured EVM indexer
---
...
```bash
./indexer -chain cchain -rpc http://luxd:9630/v1/bc/C/rpc -port 4000
```

## API Endpoints

The EVM adapter exposes 40+ REST endpoints. See the [API Reference](/indexer/api) for details.
