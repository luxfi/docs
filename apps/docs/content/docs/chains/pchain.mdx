...
- **Validator Management**: Adding and removing validators from the primary network and chains
- **Staking**: Delegating LUX to validators and distributing staking rewards
- **Chain Creation**: Creating new chains and deploying blockchains on them
