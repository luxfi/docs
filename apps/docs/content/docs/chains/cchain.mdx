...
|---------|----------|----------|-------------|
| Mainnet | 96369 | LUX | `https://api.lux.network/v1/chain/c` |
| Testnet | 96368 | LUX | `https://api.lux-test.network/v1/chain/c` |
| Devnet | 96370 | LUX | `https://api.lux-dev.network/v1/chain/c` |
...
The C-Chain exposes the standard Ethereum JSON-RPC API. All methods are available at the `/v1/chain/c` endpoint.
...
WebSocket connections are available at `/v1/chain/c/ws` for real-time event subscriptions.
...
- **RPC URL**: `https://api.lux.network/v1/chain/c`
- **Chain ID**: 96369
- **Currency Symbol**: LUX
...
```bash
forge create --rpc-url https://api.lux.network/v1/chain/c \
