---
title: "EVM Chains"
description: "Sovereign L1 EVM chains with configurable gas, fees, and precompiles. Used by Zoo, Hanzo, SPC, Pars."
icon: Code
---
...
```
https://api.zoo.network/v1/chain/zoo
https://api.hanzo.network/v1/chain/hanzo
https://api.spc.network/v1/chain/spc
https://api.pars.network/v1/chain/pars
```
