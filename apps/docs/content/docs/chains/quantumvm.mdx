...
description: "Post-quantum cryptographic operations: Pulsar signatures, Quasar consensus, parallel verification."
icon: Atom
---
...
| `coronaKeySize` | 1,024 | Pulsar key size in bytes |
