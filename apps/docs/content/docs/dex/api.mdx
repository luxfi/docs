...
The Trading API provides unified swap routing across on-chain V4 pools (Partner DEX precompile) and off-chain broker venues.
...
|-------|------|-------------|
| `v4_native` | On-chain | Partner DEX V4 precompile (LP-9012) |
