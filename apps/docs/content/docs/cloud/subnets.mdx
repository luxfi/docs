...
- [Architecture](/learn/architecture) - How subnets fit into the Lux architecture
- [Run a Validator](/nodes/validator) - Become a subnet validator
- [Platform API](/reference/platform) - Programmatic subnet management
