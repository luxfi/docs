...
func main() {
    client, err := ethclient.Dial("https://api.lux.network/v1/bc/C/rpc")
    if err != nil {
        log.Fatal(err)
    }
...
w3 = Web3(Web3.HTTPProvider("https://api.lux.network/v1/bc/C/rpc"))
...
- [JavaScript SDK Reference](/api-reference/sdk-js) - Complete JS/TS API reference
- [Go SDK Reference](/api-reference/sdk-go) - Complete Go API reference
- [Smart Contracts](/cloud/contracts) - Deploy contracts using these SDKs
- [Tutorials](/cloud/tutorials) - End-to-end examples with SDK code
