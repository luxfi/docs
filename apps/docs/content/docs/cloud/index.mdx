...
<Cards>
  <Card title="Smart Contracts" href="/cloud/contracts">
    Deploy Solidity contracts on Lux C-Chain
  </Card>
  <Card title="SDKs" href="/cloud/sdks">
    JavaScript, Go, and Rust SDKs
  </Card>
  <Card title="Chains" href="/chains">
    Create and deploy custom chains
  </Card>
  <Card title="Tutorials" href="/cloud/tutorials">
