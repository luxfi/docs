...
<Cards>
  <Card title="Smart Contracts" href="/build/contracts">
    Deploy Solidity contracts on Lux C-Chain
  </Card>
  <Card title="SDKs" href="/build/sdks">
    JavaScript, Go, and Rust SDKs
  </Card>
  <Card title="Subnets" href="/build/subnets">
    Create and deploy custom subnets
  </Card>
  <Card title="Tutorials" href="/build/tutorials">
