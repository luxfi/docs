...
|----------|--------|-------|-------------|
| C-Chain | `explore.lux.network` | Mainnet C-Chain | `luxd-1:9630/v1/chain/c` |
| Zoo | `explore-zoo.lux.network` | Zoo chain | `luxd-1:9630/v1/chain/{id}/rpc` |
| Hanzo | `explore-hanzo.lux.network` | Hanzo chain | `luxd-1:9630/v1/chain/{id}/rpc` |
| SPC | `explore-spc.lux.network` | SPC chain | `luxd-1:9630/v1/chain/{id}/rpc` |
| Pars | `explore-pars.lux.network` | Pars chain | `luxd-1:9630/v1/chain/{id}/rpc` |
