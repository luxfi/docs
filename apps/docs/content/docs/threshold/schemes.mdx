...
description: CGGMP21, FROST, BLS, and Corona threshold signature scheme comparison
icon: Layers
---
...
| Property | CGGMP21 | FROST | BLS | Corona |
|----------|---------|-------|-----|----------|
...
Corona is used alongside BLS in Lux Quasar consensus for post-quantum security bundles, not as a standalone chain signing scheme.
