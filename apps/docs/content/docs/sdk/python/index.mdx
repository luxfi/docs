...
The Python SDK (`luxfi-sdk`) provides a high-level interface for interacting with Lux Network from Python applications. It supports C-Chain and L2 EVM chains via Web3.py, with convenience wrappers for common operations.
...
|-------|-----|-------------|-----------|
| C-Chain | Yes | Yes | Yes |
| L2 EVM (Zoo, Hanzo, SPC, Pars) | Yes | Yes | Yes |
