...
The settlement engine enforces instant-buy limits based on the account's KYC verification tier. See the [Settlement Engine](/broker/settlement) page for full details.
