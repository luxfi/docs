...
- [`luxfi/quasar`](https://github.com/luxfi/quasar) — umbrella spec
  registers Pulsar as the M-LWE threshold primitive feeding the
  Pulsar / Aurora / Polaris cert profiles
