...
| `github.com/luxfi/precompile` | 1.26.1 | `luxfi/geth@v1.16.73`, `luxfi/fhe@v1.7.6`, `luxfi/lattice/v7`, `luxfi/threshold@v1.5.0`, `luxfi/corona@v0.2.0`, `cloudflare/circl@v1.6.3`, `consensys/gnark-crypto@v0.19.2` |
...
| C | Chain | C | Chain |
|---|-------|---|-------|
| 0 | P-Chain (platform) | 6 | Z-Chain (zk-rollup/privacy) |
| 1 | X-Chain (avm) | 7 | Q-Chain (PQ consensus signing) |
| 2 | C-Chain (main EVM) | 8 | Zoo (sovereign L1 EVM) |
| 3 | D-Chain (DEX/CLOB) | 9 | Hanzo (sovereign L1 EVM) |
| 4 | A-Chain (AI/attestation) | A | SPC (sovereign L1 EVM) |
| 5 | B-Chain (bridge) | | |
...
| `ManagerRole` | 3 | Can add/remove Enabled only |
...
Events are emitted on role changes with gas cost `AllowListEventGasCost`.
...
| CORONA | 75,000 | Threshold lattice signatures (post-quantum) |
