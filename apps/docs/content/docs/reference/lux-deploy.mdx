...
~/work/lux/deploy/
  ...
  cmd/
    deploy-chains/
      main.go            # Go tool for P-Chain chain/blockchain creation
...
4. **Chain Layer** -- Sovereign L1 deployment, genesis configuration
...
### Sovereign L1 EVM VMID

`ag3GReYPNuSR17rUP8acMdZipQBikdXNRKDyFszAysmy3vDXE` (used for all sovereign L1 chains)
...
5. **No well-known test keys**: Mnemonic-based key derivation only
