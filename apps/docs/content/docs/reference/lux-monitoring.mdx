...
| `c-chain` | `/v1/bc/C/metrics` | `luxd:9630` | `c-chain-mainnet` |
| `c-chain-rpc` | `/v1/bc/C/rpc` | `luxd:9630` | `c-chain-rpc` |
| `x-chain` | `/v1/bc/X/metrics` | `luxd:9630` | `x-chain-mainnet` |
| `p-chain` | `/v1/bc/P/metrics` | `luxd:9630` | `p-chain-mainnet` |
