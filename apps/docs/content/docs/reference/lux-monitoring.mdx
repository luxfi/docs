...
| Lux Node | `prometheus` | `http://host.docker.internal:9650/v1/metrics` |
...
| `luxd` | `/v1/metrics` | `luxd:9630`, `host.docker.internal:9630` | `lux-mainnet` |
| `c-chain` | `/v1/chain/c/metrics` | `luxd:9630` | `c-chain-mainnet` |
| `c-chain-rpc` | `/v1/chain/c` | `luxd:9630` | `c-chain-rpc` |
| `x-chain` | `/v1/chain/x/metrics` | `luxd:9630` | `x-chain-mainnet` |
| `p-chain` | `/v1/chain/p/metrics` | `luxd:9630` | `p-chain-mainnet` |
| `lux-health` | `/v1/health` | `luxd:9630` | `lux-health` |
...
| `dex-quantum` | 15s | `lux-dex-node:8080` | Corona-BLS signatures |
...
- `lux/lux-node.md` -- Node that exports metrics at `/v1/metrics`
