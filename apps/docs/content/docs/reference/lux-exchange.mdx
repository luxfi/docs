...
|-------|----------|-------------|-----|----------|
| Lux Mainnet | 96369 | LUX | `https://api.lux.network/v1/chain/c` | `explore.lux.network` |
| Lux Testnet | 96368 | LUX | `https://api.lux-test.network/v1/chain/c` | `explore.lux-test.network` |
...
| Lux Dev | 1337 | LUX | `http://localhost:8545/v1/chain/c` | local |
...
| G-Chain GraphQL | `localhost:9630/v1/chain/g/graphql` | Native blockchain data (blocks, accounts, balances) |
