...
|-------|----------|-------------|-----|----------|
| Lux Mainnet | 96369 | LUX | `https://api.lux.network/v1/bc/C/rpc` | `explore.lux.network` |
| Lux Testnet | 96368 | LUX | `https://api.lux-test.network/v1/bc/C/rpc` | `explore.lux-test.network` |
...
| Hanzo Network | 36963 | HANZO | Lux chain RPC | `explore-hanzo.lux.network` |
| SPC Network | 36911 | SPC | Lux chain RPC | `explore-spc.lux.network` |
| Pars Network | 494949 | PARS | Lux chain RPC | `explore-pars.lux.network` |
| Lux Dev | 1337 | LUX | `http://localhost:8545/v1/bc/C/rpc` | local |
...
| G-Chain GraphQL | `localhost:9630/v1/bc/G/graphql` | Native blockchain data (blocks, accounts, balances) |
