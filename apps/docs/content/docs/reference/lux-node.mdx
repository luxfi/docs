...
- **Consensus**: Quasar dual finality (BLS + Ringtail post-quantum threshold)
...
│   ├── quasar/       — Dual quantum-safe finality (BLS + Ringtail)
...
|-------|--------|----|---------|
| **Q-Chain** | Q | quantumvm | Post-quantum cryptography, Ringtail keys, QuasarCert finality certificates |
...
SignatureTypeQuasar   = 2  // Dual BLS + Ringtail
