...
- **Consensus**: Quasar hybrid finality (BLS + Corona post-quantum threshold)
...
│   ├── quasar/       — Hybrid quantum-safe finality (BLS + Corona)
...
|-------|--------|----|---------|
| **Q-Chain** | Q | quantumvm | Post-quantum cryptography, Corona keys, quantum stamps |
