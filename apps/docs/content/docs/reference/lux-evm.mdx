...
| Module | `github.com/luxfi/evm` |
| Go version | 1.26.1 |
| C-Chain RPC | `http://<node>:9630/v1/bc/C/rpc` |
| C-Chain WebSocket | `ws://<node>:9630/v1/bc/C/ws` |
...
client, err := ethclient.Dial("http://localhost:9630/v1/bc/C/rpc")
if err != nil {
    return err
}
...
```
POST /v1/bc/C/rpc          -- Standard EVM JSON-RPC
WS   /v1/bc/C/ws           -- WebSocket subscriptions
POST /v1/bc/C/lux          -- Lux-specific APIs (validators)
POST /v1/bc/C/admin        -- Admin APIs (import/export, profiling)
```
