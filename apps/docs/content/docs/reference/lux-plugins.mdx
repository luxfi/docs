...
### Sovereign L1 EVM (Lux EVM, legacy alias `subnet-evm`)

| Field | Value |
|-------|-------|
| Alias | `subnet-evm` (legacy upstream alias; canonical: Lux EVM) |
...
4. **Configure consensus**: Set Quasar/Wave consensus parameters appropriate for your use case
