...
plugins-core/
  vms/                   -- VM definitions (one YAML per VM)
    ...
    subnet-evm.yaml          Sovereign L1 EVM (Solidity smart contracts)
...
| Description | Sovereign L1 EVM -- simplified Coreth VM for sovereign L1 chains with full Ethereum Virtual Machine and Solidity smart contract support |
...
Sovereign L1 EVM is the primary VM for creating new EVM-compatible blockchains on Lux. It is a simplified version of Coreth (C-Chain VM), parameterizable for different throughput and gas configurations.
...
| Homepage | `https://github.com/luxfi/evm` |
| VM | `evm` (Coreth/Sovereign L1 EVM) |
...
~/.lux/plugins/srEXiWaHuhNyGwPUi444Tu47ZEDwxTWrbQiuD7FmgSAQ6X7Dy   # Sovereign L1 EVM
```
...
- `lux/lux-evm.md` -- Sovereign L1 EVM execution engine
