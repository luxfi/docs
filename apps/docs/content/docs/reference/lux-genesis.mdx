...
- Never expose or commit private keys or mnemonics
...
genesis/
  ...
  configs/               # Embedded genesis JSON (22 network configs)
    ...
    zoo-mainnet/         # Zoo chain genesis
    spc-mainnet/         # SPC chain genesis
    hanzo-mainnet/       # Hanzo chain genesis
    pars-mainnet/        # Pars chain genesis
    ...                  # testnet/devnet variants for each chain
  builder/               # Genesis builder with tests
  chains/                # Sovereign L1 chain definitions (ai, spc, zoo)
