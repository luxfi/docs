...
| Chain | ID | RPC |
|-------|----|-----|
| Lux Mainnet | 96369 | `api.lux.network/v1/chain/c` |
| Lux Testnet | 96368 | `api.lux-test.network/v1/chain/c` |
| Zoo Mainnet | 200200 | `api.zoo.network/v1/chain/zoo` or `api.zoo.network/v1/chain/zoo` |
| Zoo Testnet | 200201 | `api.zoo-test.network/v1/chain/zoo` |
...
| Lux | 43114 | `api.lux.network/v1/chain/c` |
