...
| File | Title | Topic |
|------|-------|-------|
| `lux-consensus.tex` | (Lux Consensus) | Core Quasar consensus family: safety and liveness proofs |
...
1. **Consensus** (4 papers): Quasar family, FPC, quantum-secure consensus, Quasar dual-certificate
