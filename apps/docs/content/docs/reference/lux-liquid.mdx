...
| Network | RPC |
|---------|-----|
| Lux Mainnet | `https://api.lux.network/v1/bc/C/rpc` |
| Lux Testnet | `https://api.lux-test.network/v1/bc/C/rpc` |
| Zoo Mainnet | `https://api.Zoo.network/v1/bc/C/rpc` |
| Hanzo Mainnet | `https://api.Hanzo.network/v1/bc/C/rpc` |
