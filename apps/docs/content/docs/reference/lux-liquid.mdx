...
| Network | RPC |
|---------|-----|
| Lux Mainnet | `https://api.lux.network/v1/chain/c` |
| Lux Testnet | `https://api.lux-test.network/v1/chain/c` |
| Zoo Mainnet | `https://api.Zoo.network/v1/chain/c` |
| Hanzo Mainnet | `https://api.Hanzo.network/v1/chain/c` |
