...
- Health checks: `curl http://localhost:9630/v1/health` every 30s

## Blockchain Explorers

| Explorer | Chain | Chain ID | Port | Image |
|----------|-------|----------|------|-------|
| LUX Explorer | C-Chain | 96369 | 4010 | `ghcr.io/luxfi/explorer` |
| Zoo Explorer | Zoo Network | 200200 | 4011 | `ghcr.io/luxfi/explorer` |
| Hanzo Explorer | AI Chain | 36963 | 4012 | `ghcr.io/luxfi/explorer` |
...
| Endpoint | URL |
|----------|-----|
| Mainnet C-Chain RPC | `http://127.0.0.1:9630/v1/bc/C/rpc` |
| Testnet C-Chain RPC | `http://127.0.0.1:9640/v1/bc/C/rpc` |
| Devnet C-Chain RPC | `http://127.0.0.1:9650/v1/bc/C/rpc` |
