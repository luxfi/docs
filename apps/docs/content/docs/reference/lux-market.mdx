...
|-------|-----|--------|-----|----------|
| Lux (C-Chain) | 96369 | LUX | `api.lux.network/v1/bc/C/rpc` | `explore.lux.network` |
| Zoo | 200200 | ZOO | `api.zoo.network/v1/bc/C/rpc` | `explore-zoo.lux.network` |
| Hanzo | 36963 | HNZ | `api.hanzo.network/v1/bc/C/rpc` | `explore-hanzo.lux.network` |
| SPC | 36911 | SPC | `api.spc.network/v1/bc/C/rpc` | `explore-spc.lux.network` |
| Pars | 494949 | PARS | `api.pars.network/v1/bc/C/rpc` | `explore-pars.lux.network` |
