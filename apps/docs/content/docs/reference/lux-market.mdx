...
|-------|-----|--------|-----|----------|
| Lux (C-Chain) | 96369 | LUX | `api.lux.network/v1/chain/c` | `explore.lux.network` |
| Zoo | 200200 | ZOO | `api.zoo.network/v1/chain/zoo` | `explore-zoo.lux.network` |
| Hanzo | 36963 | HNZ | `api.hanzo.network/v1/chain/hanzo` | `explore-hanzo.lux.network` |
| SPC | 36911 | SPC | `api.spc.network/v1/chain/spc` | `explore-spc.lux.network` |
| Pars | 494949 | PARS | `api.pars.network/v1/chain/pars` | `explore-pars.lux.network` |
