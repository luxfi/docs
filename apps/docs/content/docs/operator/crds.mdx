...
Declares a sovereign L1 chain with VM configuration and validator assignments.
...
Deploys a blockchain data indexer with SQLite storage and `/v1/explorer/*` API.
