...
See [here](/reference/luxd/admin-api.md) for more information.

#### `--api-auth-required` (boolean)

If set to `true`, API calls require an authorization token. Defaults to `false`.
See [here](/reference/luxd/auth-api.md) for more information.
...
[here](/reference/luxd/auth-api.md) for more information.
...
[here](/reference/luxd/health-api.md) for more information.
...
[here](/reference/luxd/index-api.md) for more information.

#### `--api-info-enabled` (boolean)

If set to `false`, this node will not expose the Info API. Defaults to `true`. See
[here](/reference/luxd/info-api.md) for more information.

#### `--api-keystore-enabled` (boolean)

If set to `true`, this node will expose the Keystore API. Defaults to `false`.
See [here](/reference/luxd/keystore-api.md) for more information.

#### `--api-metrics-enabled` (boolean)

If set to `false`, this node will not expose the Metrics API. Defaults to
`true`. See [here](/reference/luxd/metrics-api.md) for more information.
...
For an example of a JSON representation of genesis data, see [genesis_local.json](https://github.com/luxdefi/luxd/blob/master/genesis/genesis_local.json).
...
Sets the directory for [VM plugins](/build/vm/intro.md). The default value is `$HOME/.luxd/plugins`.
