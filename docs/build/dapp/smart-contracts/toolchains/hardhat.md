...
repository](https://github.com/luxdefi/smart-contract-quickstart) and
...
(Note that you can also [download pre-compiled LuxGo
...
[`fund-cchain-addresses`](https://github.com/luxdefi/smart-contract-quickstart/blob/main/scripts/fund-cchain-addresses.js).
...
In
[`package.json`](https://github.com/luxdefi/smart-contract-quickstart/blob/main/package.json)
...
[ERC20.sol](https://github.com/luxdefi/smart-contract-quickstart/blob/main/contracts/ERC20.sol)
