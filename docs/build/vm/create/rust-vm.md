...
description: Learn how to develop virtual machines on Lux using Rust.
...
The Lux Rust SDK is a developer toolkit composed of powerful building blocks and primitive
types. This tutorial will walk you through the creation of a simple VM known as the [TimestampVM RS](https://github.com/luxdefi/timestampvm-rs) using the Rust SDK. Each block in the TimestampVM's
...
- Bookmark and review the [rs](https://github.com/luxdefi/rs) GitHub
  repository, specifically the Subnet traits and helpers defined in the `types` crate
- For developers new to Rust please visit the free online book [The Rust Programming
  ...
  [types-rs](https://github.com/luxdefi/types-rs), a predecessor of
  the [rs](https://github.com/luxdefi/rs) repository that is now the
...
Completely new to creating a custom VM on Lux? No problem please review [Introduction to VMs](/build/vm/intro.md).
...
[snowman::block::ChainVM](https://github.com/luxdefi/types-rs/blob/main/src/subnet/rpc/snowman/block.rs)
...
- [ChainVM
  GoDoc](https://pkg.go.dev/github.com/luxdefi/luxd/snow/engine/snowman/block#ChainVm)
- [Lux Proto Docs](https://buf.build/luxdefi/lux/docs/main:vm#vm.VM)
- [Snowman VMs](https://github.com/luxdefi/luxd/tree/master/vms#snowman-vms)
...
repository](https://github.com/luxdefi/timestampvm-rs).
