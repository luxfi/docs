...
tool](https://github.com/luxdefi/cli), but for now we need to do it manually.

Go to the [releases page](https://github.com/luxdefi/subnet-evm/releases) of the Subnet-EVM
...
```bash
wget https://github.com/luxdefi/subnet-evm/releases/download/v0.2.9/subnet-evm_0.2.9_linux_amd64.tar.gz
```
...
since [Subnet-EVM v0.2.8](https://github.com/luxdefi/subnet-evm/releases/tag/v0.2.8), we introduced
