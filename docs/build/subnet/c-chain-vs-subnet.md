...
[Subnet-EVM](https://github.com/luxdefi/subnet-evm) effectively creates an application-specific
EVM-chain with full control over native(gas) coins. The operator can pre-allocate the native tokens
in the chain genesis, and mint more using the [Subnet-EVM](https://github.com/luxdefi/subnet-evm)
...
throughput. Plus, [Subnet-EVM](https://github.com/luxdefi/subnet-evm) supports fee configuration
...
on-chain transactions. With [Subnet-EVM](https://github.com/luxdefi/subnet-evm), an application can
