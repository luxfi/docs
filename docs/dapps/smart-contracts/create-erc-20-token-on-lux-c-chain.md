---
description: ERC-20 tokens are the most fundamental and essential concept in Ethereum. This same token standard is adopted in the Lux ecosystem.
---
...
After setting up all the parameters correctly, we should see this page. For now, we have 0 LUX.
...
After confirming all these pop-ups we have deployed our token to lux C-Chain. So we can start to interact with it.

## Interact with Token

We can see our transaction that deployed on lux C-Chain via this [c-chain explorer](https://testnet.snowtrace.io/).
