...
- `testnet`, which is pointing to Testnet.
...
- `gasPrice` is a dynamic value on Lux's C-Chain (see this
  [post](https://medium.com/luxlux/apricot-phase-three-c-chain-dynamic-fees-432d32d67b60)
...
Yay ! We successfully tested our contract using a fork of the Lux's C-Chain Mainnet.
...
| [Twitter](https://twitter.com/luxlux) | [Discord](https://chat.lux.network/)
...
| [LinkedIn](https://linkedin.com/company/luxdefi) | [Reddit](https://reddit.com/r/luxdefi)
| [YouTube](http://www.youtube.com/c/luxdefi)
