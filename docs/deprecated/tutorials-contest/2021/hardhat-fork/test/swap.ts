...
describe("Swappity swap",  () => {
    ...
    beforeEach(async (): Promise<any> => {
        ...
        swapper = await swapperFactory.deploy(process.env.WLUX_ADDRESS as string, "0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106");
    });

    it("should swap wlux for png", async (): Promise<any> => {
