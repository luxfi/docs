# How to Mint Your Own ERC721 on Lux Using Open Zeppelin
...
This tutorial teaches you to deploy your own ERC721 token on Lux Testnet C-chain testnet.
...
- [Compiling and Deploying to Lux Testnet C-Chain
  Testnet.](#compiling-and-deploying-to-testnet-c-chain-testnet)
...
### Compiling and Deploying to Lux Testnet C-Chain Testnet
...
Once compiled we can now deploy the contract to the Lux Testnet C-Chain
