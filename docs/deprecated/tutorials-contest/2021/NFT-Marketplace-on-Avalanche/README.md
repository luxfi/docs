...
- [LUX Fuji Testnet](#lux-fuji-testnet)
...
We are going to test the marketplace on LUX Fuji Testnet. First, you need to
add LUX Fuji Testnet to MetaMask. Open MetaMask and view networks, then click
on `Custom RPC`.
...
Lastly, we will need some LUX to deploy our contracts. Use this [LUX Fuji Testnet Faucet
...
## Deploying to the Lux Mainnet

Deploying to Mainnet is the same as deploying to [Testnet](#lux-fuji-testnet).
