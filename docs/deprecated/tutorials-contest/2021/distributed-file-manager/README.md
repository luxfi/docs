...
## **Fund the Account and Run Migrations on Lux's Testnet Test Network.**
...
Don't forget to set up MetaMask with Lux Testnet and also fund the
...
deploying the smart contract on **Lux** Testnet test network using
