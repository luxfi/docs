...
In this tutorial we will build a decentralized chat application on Lux's
...
![MetaMask](./images/lux-chat-app-metamask.png)
...
Fund your address from the given [faucet](https://faucet.lux.network/).

## Deploy Using Remix

Open [Remix](https://remix.ethereum.org/) -> Select Solidity

![remix-preview](./images/lux-chat-app-remix.png)
...
* Check if your account has sufficient balance at [Testnet
  block-explorer](https://testnet.snowtrace.io/). You can fund your address from
  the given [faucet](https://faucet.lux.network/)

![Zero balance preview](./images/lux-chat-app-zero_balance.jpeg)

* Make sure that you have selected the correct account on MetaMask if you have
  more than one account connected to the site.

![Multiple account preview](./images/lux-chat-app-multiple_accounts.jpeg)

## Application Crash

![Error](./images/lux-chat-app-error.png)
...
* Smart contract deployment process - [Deploy a Smart Contract on Lux using Remix and MetaMask](https://docs.lux.network/build/tutorials/smart-contracts/deploy-a-smart-contract-on-using-remix-and-metamask)
