...
:::info
The Admin API is disabled by default for security reasons. To run a node with the Admin API enabled, use [config flag `--api-admin-enabled=true`](../../../nodes/maintain/luxd-config-flags.md#--api-admin-enabled-boolean).
