...
For validation and cross-chain transfer on the Mainnet, you should issue transactions through [LuxJS](../../luxjs/README.md). That way control keys for your funds won't be stored on the node, which significantly lowers the risk should a computer running a node be compromised. See following docs for details:

- [Transfer LUX Tokens Between Chains](../../../quickstart/cross-chain-transfers.md)
