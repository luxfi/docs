...
## v1.7.17 - Verbier ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.17))
...
## v1.7.16 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.16))
...
## v1.7.15 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.15))
...
## v1.7.14 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.14))
...
## v1.7.13 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.13))
...
## v1.7.12 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.12))
...
## v1.7.11 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.11))
...
## v1.7.10 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.10))
...
## v1.7.9 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.9))
...
## v1.7.8 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.8))
...
## v1.7.7 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.7))
...
## v1.7.6 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.6))
...
## v1.7.5 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.5))
...
## v1.7.4 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.4))
...
## v1.7.3 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.3))
...
## v1.7.1 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.1))
...
## v1.7.0 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.7.0))
...
## v1.6.5 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.6.5))
...
## v1.6.4 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.6.4))
...
## v1.6.3 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.6.3))
...
## v1.6.2 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.6.2))
...
- Added `--throttler-inbound-node-max-processing-msgs`. See [here.](../../nodes/maintain/luxd-config-flags.md#message-rate-limiting-throttling)
- Added `--db-config-file`. See [here.](../../nodes/maintain/luxd-config-flags.md#database-config)

**API**

- API method `avm.exportLUX` has been removed. Use `avm.export` instead.
- API method `avm.importLUX` has been removed. Use `avm.import` instead.
...
## v1.6.1 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.6.1))
...
- API method `avm.exportLUX` should be removed in favor of `avm.export`
- API method `avm.importLUX` should be removed in favor of `avm.import`
...
## v1.6.0 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.6.0))
...
More info can be found [here](https://medium.com/luxlux/apricot-phase-four-snowman-and-reduced-c-chain-transaction-fees-1e1f67b42ecf).
...
- `lux_C_blks_built` / `lux_P_blks_built`: Number of blocks that have been built locally on the C-Chain and P-Chain, respectively.
- `lux_C_blks_builds_failed` / `lux_P_blks_builds_failed`: Number of calls to BuildBlock that failed on the C-Chain and P-Chain, respectively.
...
## v1.5.3 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.5.3))

This version is backwards compatible to [v1.5.0](https://github.com/luxdefi/luxd/releases/tag/v1.5.0).
...
This update is backwards compatible with [v1.5.0](https://github.com/luxdefi/luxd/releases/tag/v1.5.0). Please see the expected update times in the v1.5.0 release.
...
## v1.5.1-eth_call ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.5.1-eth_call))

This update is backwards compatible with [v1.5.0](https://github.com/luxdefi/luxd/releases/tag/v1.5.0). Please see the expected network upgrade times in the v1.5.0 release.

This update is a hotfix for v1.5.1 that allows using eth_call without the externally owned account check.

## v1.5.1 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.5.1))
...
## v1.5.0 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.5.0))
...
More info can be found [here](https://medium.com/luxlux/apricot-phase-three-c-chain-dynamic-fees-432d32d67b60).
...
- Added `./luxd` as the default command in the docker image.
...
## v1.4.12 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.12))
...
## v1.4.11 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.11))
...
Many Prometheus metrics were renamed, and many histograms were replaced with 2 gauges. See [here](https://github.com/luxdefi/lux-monitoring/tree/master/grafana/dashboards) for updated Grafana Dashboards.
...
## v1.4.9 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.9))
...
## v1.4.8 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.8))
...
## v1.4.7 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.7))
...
## v1.4.6 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.6))
...
## v1.4.5 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.5))
...
## v1.4.4 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.4))
...
## v1.4.3 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.3))
...
## v1.4.2 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.2))
...
## v1.4.1 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.1))
...
## v1.4.0 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.4.0))
...
**The related blog post can be found** [**here**](https://medium.com/luxlux/apricot-phase-two-berlin-eips-enhanced-lux-native-token-ant-support-c2ae0febe5bf)**.**
:::
...
- Added the ability to run luxd's main binary as a plugin.
...
## v1.3.2 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.3.2))
...
- Changed the `Keystore` to ensure only encrypted values are sent over the IPC between luxd and plugin processes.
...
## v1.3.1 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.3.1))
...
## v1.3.0 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.3.0))
...
- Reduced C-chain gas cost from 470 nLUX to 225 nLUX.
...
## **v1.2.4 (**[**View on GitHub**](https://github.com/luxdefi/luxd/releases/tag/v1.2.4)**)**
...
- Added additional error handling to Lux Tx verification during bootstrapping.
...
## **v1.2.3 (**[**View on GitHub**](https://github.com/luxdefi/luxd/releases/tag/v1.2.3-signed)**)**
...
## **v1.2.2 (**[**View on GitHub**](https://github.com/luxdefi/luxd/releases/tag/v1.2.2)**)**
...
## **v1.2.1 (**[**View on GitHub**](https://github.com/luxdefi/luxd/tree/v1.2.1)**)**
...
- Added additional caching to the Lux bootstrapping traversal.
...
## v1.2.0 ([View on GitHub](https://github.com/luxdefi/luxd/tree/v1.2.0))
...
- Limited number of processing blocks in Snowman and processing txs in Lux
...
## v1.1.5 ([View on GitHub](https://github.com/luxdefi/luxd/tree/v1.1.5))
...
## v1.1.4 ([View on GitHub](https://github.com/luxdefi/luxd/tree/v1.1.4))
...
- Fixed optimistic vote bubbling in the Lux Engine to correctly pass votes through processing vertices.
...
## v1.1.3 ([View on GitHub](https://github.com/luxdefi/luxd/tree/v1.1.3))
...
## v1.1.2 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.1.2))
...
- Fixed bootstrapping processing cache to reduce duplicated traversals when bootstrapping Lux.
...
## v1.1.1 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.1.1))
...
## v1.1.0 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.1.0))
...
## v1.0.6 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.0.6))
...
- For those using [https://explorerapi.lux-dev.network/](https://explorerapi.lux-dev.network/), the URL is going to be shut down in a future release. Please switch over to [https://explorerapi.lux.network/](https://explorerapi.lux.network/).

For assistance with this update, you can join our [Discord](https://chat.lux.network/) for help.

## v1.0.5 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.0.5))
...
## v1.0.4 ([View on GitHub](https://github.com/luxdefi/luxd/releases/tag/v1.0.4))
