...
[C-Chain](/learn/lux/platform.md#c-chain). On
...
[`platform.import`](/reference/luxd/p-chain/api.md#platformimportlux).
...
**DEPRECATED—instead use** [`lux.export`](/reference/luxd/c-chain/api.md#luxexport).
...
- `privateKey` is the CB58 encoded string representation of the private key that controls
  `address`. It has a `PrivateKey-` prefix and can be used to import a key via `lux.importKey`.
...
`C-lux18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5`.
