...
description: This page is an overview of the AVM transaction format associated with LuxGo X-Chain API.
...
A transferable output contains an `AssetID` and an [`Output`](/reference/luxd/x-chain/txn-format.md#outputs).

- **`AssetID`** is a 32-byte array that defines which asset this output references.
- **`Output`** is an output, as defined
  [below](/reference/luxd/x-chain/txn-format.md#outputs). Outputs have four possible types:
  [`SECP256K1TransferOutput`](/reference/luxd/x-chain/txn-format.md#secp256k1-transfer-output),
  [`SECP256K1MintOutput`](/reference/luxd/x-chain/txn-format.md#secp256k1-mint-output),
  [`NFTTransferOutput`](/reference/luxd/x-chain/txn-format.md#nft-transfer-output)
  and [`NFTMintOutput`](/reference/luxd/x-chain/txn-format.md#nft-mint-output).
...
- **`Input`** is an input, as defined below. This can currently only be a [SECP256K1 transfer input](/reference/luxd/x-chain/txn-format.md#secp256k1-transfer-input)
...
- **`TransferOp`** is a [transferable operation object](/reference/luxd/x-chain/txn-format.md#operations).
...
[`SECP256K1TransferOutput`](/reference/luxd/x-chain/txn-format.md#secp256k1-transfer-output),
[`SECP256K1MintOutput`](/reference/luxd/x-chain/txn-format.md#secp256k1-mint-output),
[`NFTTransferOutput`](/reference/luxd/x-chain/txn-format.md#nft-transfer-output) and
[`NFTMintOutput`](/reference/luxd/x-chain/txn-format.md#nft-mint-output).
...
- **`AddressIndices`** is a list of unique ints that define the private keys
  ...
  [UTXO](/reference/luxd/x-chain/txn-format.md#utxo). Each UTXO has an array of
  ...
  high.
- **`MintOutput`** is a [SECP256K1 Mint output](/reference/luxd/x-chain/txn-format.md#secp256k1-mint-output).
- **`TransferOutput`** is a [SECP256K1 Transfer output](/reference/luxd/x-chain/txn-format.md#secp256k1-transfer-output).
...
- **`AddressIndices`** is a list of unique ints that define the private keys
  ...
  that can spend the UTXO. Each int represents the index in this address array
  that will sign this transaction. The array must be sorted low to high.
- **`NFTTransferOutput`** is the output of this operation and must be an [NFT Transfer Output](/reference/luxd/x-chain/txn-format.md#nft-transfer-output). This
...
- **`Outputs`** is a variable length array of
  [outputs](/reference/luxd/x-chain/txn-format.md#outputs), as defined above.
...
An NFT credential is the same as an [secp256k1 credential](/reference/luxd/x-chain/txn-format.md#secp256k1-credential) with a
...
[`CreateAssetTx`](/reference/luxd/x-chain/txn-format.md#what-unsigned-create-asset-tx-contains),
[`OperationTx`](/reference/luxd/x-chain/txn-format.md#what-unsigned-operation-tx-contains),
[`ImportTx`](/reference/luxd/x-chain/txn-format.md#what-unsigned-import-tx-contains),
and
[`ExportTx`](/reference/luxd/x-chain/txn-format.md#what-unsigned-export-tx-contains).
They all embed
[`BaseTx`](/reference/luxd/x-chain/txn-format.md#what-base-tx-contains), which
...
- **`Outputs`** is an array of [transferable output objects](/reference/luxd/x-chain/txn-format.md#transferable-output). Outputs must
  ...
  fee.
- **`Inputs`** is an array of [transferable input objects](/reference/luxd/x-chain/txn-format.md#transferable-input). Inputs must be
...
- **`InitialStates`** is a variable length array that defines the feature
  extensions this asset supports, and the [initial state](/reference/luxd/x-chain/txn-format.md#initial-state) of those feature
  extensions.
...
- **`BaseTx`**
- **`Ops`** is a variable-length array of [Transferable Ops](/reference/luxd/x-chain/txn-format.md#transferable-op).
...
- **`Ins`** is a variable length array of [Transferable Inputs](/reference/luxd/x-chain/txn-format.md#transferable-input).
...
- **`Outs`** is a variable length array of [Transferable Outputs](/reference/luxd/x-chain/txn-format.md#transferable-output).
...
A signed transaction is an unsigned transaction with the addition of an array of [credentials](/reference/luxd/x-chain/txn-format.md#credentials).
...
- **`Credentials`** is an array of
  [credentials](/reference/luxd/x-chain/txn-format.md#credentials). Each credential
...
- **`Output`** is the output object that created this UTXO. The serialization of
  Outputs was defined above. Valid output types are [SECP Mint Output](/reference/luxd/x-chain/txn-format.md#secp256k1-mint-output), [SECP Transfer Output](/reference/luxd/x-chain/txn-format.md#secp256k1-transfer-output),
  [NFT Mint Output](/reference/luxd/x-chain/txn-format.md#nft-mint-output), [NFT Transfer Output](/reference/luxd/x-chain/txn-format.md#nft-transfer-output).
