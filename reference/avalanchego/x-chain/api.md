...
the [C-Chain's `lux.import`](/reference/luxd/c-chain/api.md#luximport) or the [P-Chain's `platform.importLUX`](/reference/luxd/p-chain/api.md#platformimportlux) to complete the transfer.
...
with [`avm.importKey`](/reference/luxd/x-chain/api.md#avmimportkey).
...
called, you must call the P-Chain’s [`platform.exportLUX`](/reference/luxd/p-chain/api.md#platformexportlux)
or C-Chain’s [`lux.export`](/reference/luxd/c-chain/api.md#luxexport) method to initiate
the transfer.
...
[`avm.createVariableCapAsset`](/reference/luxd/x-chain/api.md#avmcreatevariablecapasset).
...
[`avm.createNFTAsset`](/reference/luxd/x-chain/api.md#avmcreatenftasset).
