...
- [Transfer LUX Tokens Between Chains](/tooling/luxjs-guides/cross-chain-transfers)
...
[`keystore.importUser`](/reference/luxd/keystore-api.md#keystoreimportuser). The user’s password
remains encrypted.
