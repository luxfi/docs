...
description: Lanzar cualquier aplicación descentralizada Solidity nueva o existente en Lux C-Chain fomenta la misma experiencia de desarrollo que Ethereum, pero se beneficia de la seguridad, velocidad e interoperabilidad de la Red Lux.
sidebar_label: Truffle
pagination_label: Usando Truffle con Lux C-Chain
sidebar_position: 1
---

# Usando Truffle con Lux C-Chain
...
la C-Chain de Lux, que es una instancia de la EVM.
...
- [Lux Network
  Runner](https://github.com/luxfi/netrunner) es una herramienta para
...
[LuxJS](/tooling/luxjs-overview.md) que se utiliza para intercambios cruzados de cadenas.
...
[aquí](https://raw.githubusercontent.com/luxfi/docs/master/scripts/fund-cchain-addresses.js).
...
El script financiará con 1000 LUX a cada cuenta en la lista de `cuentas` de arriba. Después de ejecutar el script con éxito, puedes verificar los saldos con:
...
[tutorial](https://support.lux.network/en/articles/6169872-how-to-make-a-cross-chain-transfer-in-the-wallet).
Debes enviar al menos `135422040` nLUX a la cuenta para cubrir el costo de despliegue de contratos.
