...
El primer paso para aprender el desarrollo de Subnets es aprender a usar [Lux-CLI](https://github.com/luxfi/cli).
...
[Subnet-EVM](https://github.com/luxfi/subnet-evm). El objetivo de tu primer comando es crear
...
Las precompilaciones son la forma en que Lux personaliza el comportamiento de tu Subnet. Son estrictamente una
