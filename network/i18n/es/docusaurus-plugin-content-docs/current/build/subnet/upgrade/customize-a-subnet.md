...
A blockchain created by or forked from [Subnet-EVM](https://github.com/luxfi/subnet-evm) can be
...
[networks folder](https://github.com/luxfi/public-chain-assets/blob/1951594346dcc91682bdd8929bcf8c1bf6a04c33/chains/11111/genesis.json).
...
- [scripts/run.sh](https://github.com/luxfi/subnet-evm/blob/master/scripts/run.sh#L99)
...
The `AllowList` solidity interface is defined as follows, and can be found in [IAllowList.sol](https://github.com/luxfi/subnet-evm/blob/5faabfeaa021a64c2616380ed2d6ec0a96c8f96d/contract-examples/contracts/IAllowList.sol):
...
[IFeeManager.sol](https://github.com/luxfi/subnet-evm/blob/5faabfeaa021a64c2616380ed2d6ec0a96c8f96d/contract-examples/contracts/IFeeManager.sol):
...
directly in Remix). It can be also found in
[IRewardManager.sol](https://github.com/luxfi/subnet-evm/blob/5faabfeaa021a64c2616380ed2d6ec0a96c8f96d/contract-examples/contracts/IRewardManager.sol):
...
[contract examples README](https://github.com/luxfi/subnet-evm/tree/master/contracts#subnet-evm-contracts).
