...
De forma predeterminada, Lux-CLI utiliza la primera dirección de la derivación, y esa dirección necesita fondos para
...
```text
✔ Ruta a su directorio de plugins de luxd (probablemente luxd/build/plugins): /home/user/go/src/github.com/luxfi/luxd/build/plugins
```
...
```text
✔ Ruta a su directorio de plugins de luxd (probablemente luxd/build/plugins): /home/user/go/src/github.com/luxfi/luxd/build/plugins█
Binario de VM escrito en /home/user/go/src/github.com/luxfi/luxd/build/plugins/tGBrMADESojmu5Et9CpbGCrmVf9fiAJtZM5ZJ3YVDj5JTu2qw
...
Puedes obtener información de la identificación de la TX de la P-Chain en [Lux Explorer](https://subnets.lux.network/)
