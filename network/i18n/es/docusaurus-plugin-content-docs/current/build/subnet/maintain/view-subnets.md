...
description: Puedes listar las Subnets que has creado con `lux subnet list`.
...
`lux subnet describe <nombreSubnet>`

Ejemplo:

````text
> lux subnet describe firstsubnet
...
```text
> lux subnet describe firstsubnet --genesis
{
    "config": {
        "chainId": 12345,
        "homesteadBlock": 0,
