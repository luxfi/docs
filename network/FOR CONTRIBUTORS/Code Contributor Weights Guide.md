...
|Year | Annual Weights Distributed | Monthly Weights Distributed | Cumulative Weights | Annual $LUX Emissions to Code | Total Weights | Annual $LUX Earned per Weight | $LUX Price Method | Implied $LUX Price | Weight Value | 
|--- | --- | --- | --- | --- | --- | --- | --- | --- |---| 
