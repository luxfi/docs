...
We will be deploying the [TokenVM](https://github.com/luxfi/sdk/tree/main/examples/tokenvm)
example built with the LuxSDK.

The following settings will be used:

- Repo url: `https://github.com/luxfi/sdk/`
- Branch Name: `main`
...
`token-cli` as shown [here](https://github.com/luxfi/sdk/blob/main/examples/tokenvm/scripts/run.sh).
...
```text
✗ Source code repository URL: https://github.com/luxfi/sdk/
```
...
Save the following content (as defined [here](https://github.com/luxfi/sdk/blob/main/examples/tokenvm/tests/e2e/e2e_test.go))
...
`token-cli` as shown [here](https://github.com/luxfi/sdk/blob/main/examples/tokenvm/scripts/run.sh).
Save the following content (generated by this [script](https://github.com/luxfi/sdk/blob/main/examples/tokenvm/scripts/run.sh))
