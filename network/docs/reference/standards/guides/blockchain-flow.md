...
interface](https://github.com/luxfi/node/blob/master/message/outbound_msg_builder.go)
...
[The networking
interface](https://github.com/luxfi/node/blob/master/network/network.go)
...
[The
`ChainRouter`](https://github.com/luxfi/node/blob/master/snow/networking/router/chain_router.go)
...
[Snowman](https://github.com/luxfi/node/blob/master/snow/consensus/snowman/consensus.go).
...
[The
`Manager`](https://github.com/luxfi/node/blob/master/chains/manager.go)
