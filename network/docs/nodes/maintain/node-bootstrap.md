...
[Luxd](https://github.com/luxfi/node) codebase is open-source
...
addresses are listed in the [Luxd codebase](https://github.com/luxfi/node/blob/master/genesis/bootstrappers.json).
...
Starting from
[Luxd version 1.7.11](https://github.com/luxfi/node/releases/tag/v1.7.11),
nodes can
...
Luxd APIs are [explicitly disabled](https://github.com/luxfi/node/blob/master/api/server/server.go#L367:L379)
