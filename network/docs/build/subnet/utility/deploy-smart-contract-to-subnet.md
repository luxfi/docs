...
Paste the [link to the Smart Contract](https://github.com/luxfi/smart-contract-quickstart/blob/main/contracts/NFT.sol)
into the popup and _Click_ import.

![remix Subnet evm sc import](/img/remix-subnet-evm-sc-import.png)

For this example, we will deploy an ERC721 contract from the [Lux Smart Contract Quickstart Repository](https://github.com/luxfi/smart-contract-quickstart).
