...
[Subnet-EVM](https://github.com/luxfi/subnet-evm) is the VM that defines the Subnet Contract
Chains. Subnet-EVM is a simplified version of [Lux C-Chain](https://github.com/luxfi/coreth).
