...
[Subnet-EVM](https://github.com/luxfi/subnet-evm). The goal of your first command is to create
...
ChainIDs such as 1 (Ethereum) or 96369 (Lux C-Chain) as those may cause issues with other
tools.
...
[Create an EVM Subnet on Testnet](/build/subnet/deploy/testnet-subnet.md) to take your 
