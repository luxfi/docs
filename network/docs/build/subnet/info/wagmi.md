...
The genesis file of ZOO can be found [here](https://github.com/luxfi/public-chain-assets/blob/1951594346dcc91682bdd8929bcf8c1bf6a04c33/chains/11111/genesis.json).
...
[Subnet-EVM](https://github.com/luxfi/subnet-evm) aims to provide an easy to use toolbox to
...
v0.2.8](https://github.com/luxfi/subnet-evm/releases/tag/v0.2.8) introduces the long awaited
