...
types. This tutorial will walk you through the creation of a simple VM known as the [TimestampVM RS](https://github.com/luxfi/timestampvm-rs) using the Rust SDK. Each block in the TimestampVM's
...
- Bookmark and review the [rs](https://github.com/luxfi/rs) GitHub
...
- For developers new to Rust please visit the free online book [The Rust Programming
  ...
  [types-rs](https://github.com/luxfi/types-rs), a predecessor of
  the [rs](https://github.com/luxfi/rs) repository that is now the
...
[snowman::block::ChainVM](https://github.com/luxfi/types-rs/blob/main/src/subnet/rpc/snowman/block.rs)
...
repository](https://github.com/luxfi/timestampvm-rs).
